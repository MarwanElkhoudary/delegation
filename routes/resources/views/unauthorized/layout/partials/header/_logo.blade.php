...
<div class="app-header-logo d-flex flex-shrink-0 align-items-center justify-content-between justify-content-lg-center">
	...
	<!--begin::Logo image-->
	<a href="?page=index">
		<img alt="Logo" src="{{ asset('assets')  }}/images/logos/moh.jpg" class="h-30px h-lg-40px theme-light-show"/>
		<img alt="Logo" src="{{ asset('assets')  }}/images/logos/moh.jpg" class="h-30px h-lg-40px theme-dark-show"/>
	</a>
	<!--end::Logo image-->
</div>
<!--end::Logo wrapper-->
