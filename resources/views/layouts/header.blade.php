        ...
        <div class="app-header-wrapper d-flex flex-grow-1 align-items-stretch justify-content-between" id="kt_app_header_wrapper">
            ...
            <div class="app-header-logo d-flex flex-shrink-0 align-items-center justify-content-between justify-content-lg-center">
                ...
                <a href="{{route('mission.index')}}">
                    <img alt="Logo"  src="{{ asset('assets')}}/images/logos/logo.svg" class="h-40px h-lg-70px theme-light-show" />
                    <img alt="Logo"  src="{{ asset('assets')}}/images/logos/logo.svg" class="h-40px h-lg-70px theme-dark-show" />
                </a>
                <!--end::Logo image-->
            </div>
            <!--end::Logo wrapper-->
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{Auth::user()->hospital?->name ? Auth::user()->hospital?->name :  Auth::user()->role?->name}}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
