...
<div class="app-sidebar-wrapper py-8 py-lg-10" id="kt_app_sidebar_wrapper">
    ...
    >
<!--layout-partial:layout/partials/sidebar/_goal.html-->
        @include('unauthorized.layout.partials.sidebar._goal')

<!--layout-partial:layout/partials/sidebar/_stats.html-->
        @include('unauthorized.layout.partials.sidebar._stats')

        <!--layout-partial:layout/partials/sidebar/_links.html-->
        @include('unauthorized.layout.partials.sidebar._links')
