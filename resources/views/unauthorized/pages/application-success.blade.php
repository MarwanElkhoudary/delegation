            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="success-card">
                        ...
                        <p class="mt-4">
                            <strong>Application Reference: #{{ str_pad($application->id, 6, '0', STR_PAD_LEFT) }}</strong>
                        </p>
                    </div>
                    ...
                    <div class="application-details">
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-value">{{ $application->humanType->name ?? 'N/A' }}</div>
                        </div>

                        <div class="detail-row">
                            <div class="detail-label">Specialization</div>
                            <div class="detail-value">{{ $application->specialization->name ?? 'N/A' }}</div>
                        </div>
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-value">{{ $application->created_at->format('d M Y, h:i A') }}</div>
                        </div>
                    </div>

                    <!-- Action Buttons -->
                    <div class="text-center mt-10">
                        <a href="/home" class="btn btn-lg btn-primary me-3">
