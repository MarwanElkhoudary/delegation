        ...
        <div class="col-lg-12">
            ...
            <div class="mission-info-box">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <span>Mission Period: {{ \Carbon\Carbon::parse($application->task->start_date)->format('M d, Y') }} - {{ \Carbon\Carbon::parse($application->task->end_date)->format('M d, Y') }}</span>
                </div>
            </div>
            ...
            <div class="application-card">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Submitted on: {{ \Carbon\Carbon::parse($application->created_at)->format('M d, Y h:i A') }}</p>
                    </div>
                    <div>
            ...
            <div class="application-card">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{{ \Carbon\Carbon::parse($application->birth_date)->format('M d, Y') }}</div>
                </div>
            ...
            <div class="application-card">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">{{ \Carbon\Carbon::parse($application->date_of_graduation)->format('M d, Y') }}</div>
                </div>
            </div>
