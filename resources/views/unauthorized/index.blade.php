...
<!--begin::Body-->
<body  id="kt_app_body"
       data-kt-app-sidebar-enabled="{{ (Auth::check() && Auth::user()->role_id != 6) ? 'true' : 'false' }}"
...
@include('unauthorized.partials.theme-mode._init')
<!-- Include Default Layout -->
@include('unauthorized.layout._default')
{{--<!-- Include Scrolltop -->--}}
{{--@include('unauthorized.partials._scrolltop')--}}
{{--<!-- Include Modals -->--}}
{{--@include('unauthorized.partials.modals._upgrade-plan')--}}
{{--@include('unauthorized.partials.modals._invite-friends')--}}
{{--@include('unauthorized.partials.modals._new-target')--}}
{{--@include('unauthorized.partials.modals._view-users')--}}
{{--@include('unauthorized.partials.modals.users-search._main')--}}
<!-- Yield Content -->
{{--@yield('content')--}}
<!--begin::Javascript-->
<script>
