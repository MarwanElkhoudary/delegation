...
<!--layout-partial:layout/partials/_toolbar.html-->
                    @include('unauthorized.layout.partials._toolbar')

                    <!--layout-partial:layout/partials/_content.html-->
{{--                    @include('unauthorized.layout.partials._content')--}}
                    @yield('content')

                </div>
                <!--end::Content wrapper-->
<!--layout-partial:layout/partials/_footer.html-->
                @include('unauthorized.layout.partials._footer')
