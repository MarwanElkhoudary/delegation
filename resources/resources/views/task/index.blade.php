...
@section('content')
    ...
    @if (session('message_delete'))
        ...
        <div class="alert alert-danger d-flex align-items-center p-5">
            ...
            <div class="d-flex flex-column">
                <!--begin::Title-->
                <h4 class="mb-1 text-dark">Success deleting</h4>
                <!--end::Title-->
    ...
    @if (session('message_edit'))
        ...
        <div class="alert alert-info d-flex align-items-center p-5">
            ...
            <div class="d-flex flex-column">
                <!--begin::Title-->
                <h4 class="mb-1 text-dark">Success Editing</h4>
                <!--end::Title-->
    ...
    <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
        ...
        <!--begin::Add customer-->
        <a href="{{url('tasks/add')}}" class="btn btn-primary" data-bs-toggle="add new Mission">
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_sales_table">
                    ...
                    <tr class="fw-semibold fs-6 text-gray-800">
                        ...
                        <th class="mw-100px" data-priority="1">Action</th>
                    </tr>
