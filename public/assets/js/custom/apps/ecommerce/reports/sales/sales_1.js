...
var KTAppEcommerceReportSales = function () {
    ...
    return {
        init: function () {
            (t = document.querySelector("#kt_ecommerce_report_sales_table_1")) && (t.querySelectorAll("tbody tr").forEach((t => {
                console.log('t: ', t)
                const e = t.querySelectorAll("td"), r = moment(e[0].innerHTML, "MMM DD, YYYY").format();
