            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `
                            <a href="#" class="btn btn-light btn-active-light-primary btn-sm m ${row.status !== 'Recently' ? 'disabled' : ''}"  ${row.status !== 'Recently' ? 'aria-disabled="true"' : ''}  data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-flip="top-end">
                                Actions
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        switch (data) {
                            ...
                            default:
                                return '<span class="badge badge badge-light-warning">' + data + '</span>';
                        }
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        switch (data) {
                            case 'Recently':
                                return '<span class="badge badge-light-primary" data-bs-toggle="tooltip" data-bs-placement="top" '+ (row.note != null ? 'title="'+row.note +'"' : '') + '>' + data + '</span>';
                            case 'Suspended':
                                return '<span class="badge badge-light-dark" data-bs-toggle="tooltip" data-bs-placement="top" '+ (row.note != null ? 'title="'+row.note +'"' : '') + '>' + data + '</span>';
                            case 'Rejected':
...
$('input[data-kt-ecommerce-order-filter="search"]').on('keyup', function () {
    ...
    $('#kt_ecommerce_report_sales_table').DataTable().search(this.value).draw();
});
