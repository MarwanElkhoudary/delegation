        ...
        <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
            ...
            <div class="d-flex flex-center flex-lg-start flex-column">
                ...
                <a href="index.html" class="mb-7">
                    <img alt="Logo"  class="h-100px h-lg-120px theme-light-show"  src="assets/images/logos/moh.jpg" />
                </a>
                <!--end::Logo-->
                <!--begin::Title-->
        ...
        <div class="d-flex flex-column-fluid flex-lg-row-auto justify-content-center justify-content-lg-end p-12 p-lg-20">
            ...
            <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
                ...
                <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
                    <!--begin::Form-->
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="index.html" action="<?php echo e(route('login')); ?>" method="post">
                        <!--begin::Heading-->
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <input type="text":value="old('username')" placeholder="Username" name="username" autocomplete="off" class="form-control bg-transparent" />
...
<?php endif; ?>
                        ...
                        <div class="fv-row mb-3">
                            ...
                            <input type="password" placeholder="Password" name="password" autocomplete="current-password" required  class="form-control bg-transparent" />
                            <!--end::Password-->
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php /**PATH D:\work\laragon\www\delegation\resources\views/auth/login.blade.php ENDPATH**/ ?>