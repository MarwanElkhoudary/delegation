										...
										<div class="d-flex flex-column flex-row-fluid">
											...
											<div class="page-title d-flex align-items-center me-3">
												...
												<h3 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bold fs-lg-2x gap-2">
													<span>
													<span class="fw-light"> </span>&nbsp;<?php echo $__env->yieldContent('role_user'); ?></span>
													<!--begin::Description-->
                                                    <!--begin::Breadcrumb-->
                                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold mb-3 fs-7">
                                                        ...
                                                        <!--end::Item-->
                                                        <!--begin::Item-->
                                                        <li class="breadcrumb-item text-gray-700 fw-bold lh-1"><?php echo $__env->yieldContent('main-title'); ?></li>
                                                        <!--end::Item-->
                                                        <!--begin::Item-->
                                                        <li class="breadcrumb-item">
                                                            <i class="ki-outline ki-right fs-7 text-gray-700 mx-n1"></i>
                                                        ...
                                                        <!--end::Item-->
                                                        <!--begin::Item-->
                                                        <li class="breadcrumb-item text-gray-700 fw-bold lh-1"><?php echo $__env->yieldContent('sub-title'); ?></li>
                                                        <!--end::Item-->
                                                        <!--begin::Item-->
...
<?php /**PATH D:\work\laragon\www\delegation\resources\views/master.blade.php ENDPATH**/ ?>