            ...
            <form class="form" action="<?php echo e(route('application.update', $application->id)); ?>" method="POST" id="apply_mission_form" enctype="multipart/form-data">
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-7">
                            ...
                            <input type="hidden" name="human_type" id="human_type" value="<?php echo e($application->human_type_id); ?>"/>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-7">
                            ...
                            <input type="date" class="form-control form-control-solid" name="birth_date" id="birth_date" max="<?php echo e(date('Y-m-d')); ?>" min="1920-01-01" value="<?php echo e($application->birth_date ? \Carbon\Carbon::parse($application->birth_date)->format('Y-m-d') : ''); ?>">
                        </div>
                        ...
                        <div class="col-md-4 mb-7">
                            ...
                            <select class="form-select form-select-solid" name="nationality" id="nationality" data-control="select2" data-placeholder="Select Nationality">
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($country); ?>" <?php echo e($application->nationality == $country ? 'selected' : ''); ?>><?php echo e($country); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="Phone" name="phone" id="phone" value="<?php echo e($application->phone); ?>"/>
                        </div>
                        ...
                        <div class="col-md-6 mb-7">
                            ...
                            <select class="form-select form-select-solid" name="languages_spoken[]" id="languages_spoken" data-control="select2" data-close-on-select="false" data-placeholder="Select languages" data-allow-clear="true" multiple="multiple">
                                ...
                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($language->id); ?>" <?php echo e($application->languages->contains($language->id) ? 'selected' : ''); ?>><?php echo e($language->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="e.g., Master's Degree" id="highest_qualification" name="highest_qualification" value="<?php echo e($application->highest_qualification); ?>"/>
                        </div>

                        <div class="col-md-6 mb-7">
                            <label class="fs-6 fw-semibold required mb-2">The Granting University</label>
                            <input type="text" class="form-control form-control-solid" id="granting_university" name="granting_university" placeholder="e.g., Harvard University" value="<?php echo e($application->granting_university); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" placeholder="e.g., USA" id="degree_granting_country" name="degree_granting_country" value="<?php echo e($application->degree_granting_country); ?>"/>
                        </div>

                        <div class="col-md-6 mb-7">
                            <label class="fs-6 fw-semibold required mb-2">Date of Graduation</label>
                            <input type="date" class="form-control form-control-solid" id="date_of_graduation" name="date_of_graduation" value="<?php echo e($application->date_of_graduation ? \Carbon\Carbon::parse($application->date_of_graduation)->format('Y-m-d') : ''); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-7">
                            ...
                            <input type="number" class="form-control form-control-solid" id="clinical_experience_years" name="clinical_experience_years" placeholder="e.g., 5" min="0" value="<?php echo e($application->clinical_experience_years); ?>">
                        </div>

                        <div class="col-md-6 mb-7">
                            <label class="fs-6 fw-semibold required mb-2">Countries Previously Served In</label>
                            <input type="text" class="form-control form-control-solid" id="countries_previously_served" name="countries_previously_served" placeholder="e.g., USA, Canada, UK" value="<?php echo e($application->countries_previously_served); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" id="previous_employers" name="previous_employers" placeholder="e.g., ABC Hospital, XYZ Clinic" value="<?php echo e($application->previous_employers); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-7">
                        ...
                        <div class="d-flex gap-5">
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="radio" value="yes" id="disaster_experience_yes" name="disaster_experience" <?php echo e($application->disaster_experience == 'yes' ? 'checked' : ''); ?>/>
                                <label class="form-check-label" for="disaster_experience_yes">Yes</label>
                            </div>
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="radio" value="no" id="disaster_experience_no" name="disaster_experience" <?php echo e($application->disaster_experience == 'no' ? 'checked' : ''); ?>/>
                                <label class="form-check-label" for="disaster_experience_no">No</label>
                            </div>
                        </div>
                    </div>

                    <div class="mb-7" id="disaster_experience_description_row" style="display: <?php echo e($application->disaster_experience == 'yes' ? 'block' : 'none'); ?>;">
                        <label class="fs-6 fw-semibold required mb-2">Please describe your disaster/emergency experience</label>
                        <textarea class="form-control form-control-solid" rows="4" id="disaster_experience_description" name="disaster_experience_description" placeholder="Describe your experience..."><?php echo e($application->disaster_experience_description); ?></textarea>
                    </div>
                    ...
                    <div class="mb-7">
                        ...
                        <div class="d-flex gap-5">
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="radio" value="yes" id="volunteer_experience_yes" name="volunteer_experience" <?php echo e($application->volunteer_experience == 'yes' ? 'checked' : ''); ?>/>
                                <label class="form-check-label" for="volunteer_experience_yes">Yes</label>
                            </div>
                            <div class="form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="radio" value="no" id="volunteer_experience_no" name="volunteer_experience" <?php echo e($application->volunteer_experience == 'no' ? 'checked' : ''); ?>/>
                                <label class="form-check-label" for="volunteer_experience_no">No</label>
                            </div>
                        </div>
                    </div>

                    <div class="mb-7" id="volunteer_experience_description_row" style="display: <?php echo e($application->volunteer_experience == 'yes' ? 'block' : 'none'); ?>;">
                        <label class="fs-6 fw-semibold required mb-2">Please describe your volunteer experience</label>
                        <textarea class="form-control form-control-solid" rows="4" id="volunteer_experience_description" name="volunteer_experience_description" placeholder="Describe your experience..."><?php echo e($application->volunteer_experience_description); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-7">
                            ...
                            <div class="d-flex gap-5">
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" type="radio" value="yes" id="visited_gaza_yes" name="visited_gaza" <?php echo e($application->visited_gaza == 'yes' ? 'checked' : ''); ?>/>
                                    <label class="form-check-label" for="visited_gaza_yes">Yes</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" type="radio" value="no" id="visited_gaza_no" name="visited_gaza" <?php echo e($application->visited_gaza == 'no' ? 'checked' : ''); ?>/>
                        ...
                        <div class="col-md-6 mb-7">
                            ...
                            <input type="text" class="form-control form-control-solid" id="place_of_work_previous_visit" name="place_of_work_previous_visit" placeholder="e.g., Al-shifa'a, Nasser" value="<?php echo e($application->place_of_work_previous_visit); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="mb-7">
                        ...
                        <textarea class="form-control form-control-solid" rows="3" id="educational_contributions" name="educational_contributions" placeholder="e.g., Conducted surgical training workshops..."><?php echo e($application->educational_contributions); ?></textarea>
                    </div>

                    <div class="mb-7">
                        <label class="fs-6 fw-semibold required mb-2">Published Scientific Papers</label>
                        <textarea class="form-control form-control-solid" rows="3" id="published_scientific_papers" name="published_scientific_papers" placeholder="e.g., Published 'AI-Driven Diagnostic Models'..."><?php echo e($application->published_scientific_papers); ?></textarea>
                    </div>

                    <div class="mb-7">
                        <label class="fs-6 fw-semibold required mb-2">Participation in Conferences or Workshops</label>
                        <textarea class="form-control form-control-solid" rows="3" id="conference_participation" name="conference_participation" placeholder="e.g., Presented a research paper at..."><?php echo e($application->conference_participation); ?></textarea>
                    </div>
                </div>
                                        ...
                                        <div data-repeater-item>
                                            <div class="row mb-5">
                                                <div class="col-md-5">
                                                    ...
                                                    <input type="text" name="doctor_name" class="form-control mb-2 mb-md-0" placeholder="Enter full name" value="<?php echo e($doctor->doctor_name); ?>"/>
                                                </div>
                                                <div class="col-md-5">
                                                    <label class="form-label">Visited Date</label>
                                                    <input type="date" name="visited_date" class="form-control mb-2 mb-md-0" value="<?php echo e($doctor->visited_date ? \Carbon\Carbon::parse($doctor->visited_date)->format('Y-m-d') : ''); ?>"/>
                                                </div>
                                                <div class="col-md-2">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-7">
                        ...
                        <?php if($application->files && $application->files->count() > 0): ?>
                            <div class="mb-5">
                                ...
                                <?php $__currentLoopData = $application->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="d-flex align-items-center justify-content-between p-3 mb-2 bg-light rounded">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="fw-bold"><?php echo e($file->file_name); ?></div>
                                                <div class="text-muted fs-7"><?php echo e(number_format($file->file_size / 1024, 2)); ?> KB</div>
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-sm btn-light-danger" onclick="deleteFile(<?php echo e($file->id); ?>)">
                                            <i class="ki-duotone ki-trash fs-5">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                                <span class="path3"></span>
...
<?php $__env->startSection('js'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            var selectedSpecialization = '<?php echo e($application->specialization_id); ?>';
