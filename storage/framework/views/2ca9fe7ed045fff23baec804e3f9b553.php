...
<?php $__env->startSection('main-title', 'Health Staff Management'); ?>
<?php $__env->startSection('sub-title', 'Applications Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex flex-wrap flex-stack mb-8">
        <h2 class="fw-bold my-2">
            ...
            <span class="fs-6 text-gray-500 fw-semibold ms-2">(<?php echo e($stats['total']); ?> Total Applications)</span>
        </h2>
    </div>
    <!--end::Header-->
                ...
                <div class="card-body d-flex flex-column">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <span class="text-gray-800 fw-bold fs-2"><?php echo e($stats['total']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body d-flex flex-column">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <span class="text-gray-900 fw-bold fs-2"><?php echo e($stats['pending']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body d-flex flex-column">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <span class="text-gray-900 fw-bold fs-2"><?php echo e($stats['approved']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body d-flex flex-column">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div>
                            ...
                            <span class="text-gray-900 fw-bold fs-2"><?php echo e($stats['rejected']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card mb-8">
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <a href="<?php echo e(route('health_staff.doctors')); ?>" class="btn btn-sm btn-primary">
        ...
        <div class="card-body pt-0">
            <div class="table-responsive">
                <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-4">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="ps-4">
                                <span class="text-gray-800 fw-bold">#<?php echo e($app->id); ?></span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <span class="text-gray-800 fw-bold"><?php echo e($app->full_name); ?></span>
                                        <span class="text-muted fw-semibold fs-7"><?php echo e($app->nationality); ?></span>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <span class="text-gray-700"><?php echo e($app->email); ?></span>
                            </td>
                            <td>
                                <span class="badge badge-light-info"><?php echo e($app->humanType->name ?? 'N/A'); ?></span>
                            </td>
                            <td>
                                <span class="text-gray-700 fw-semibold"><?php echo e($app->specialization->name ?? 'N/A'); ?></span>
                            </td>
                            <td>
                                <span class="text-gray-700">Mission #<?php echo e($app->task_id); ?></span>
                            </td>
                            <td>
                                <span class="badge badge-<?php echo e($app->status_color); ?>">
                                    <?php echo e(ucfirst($app->application_status)); ?>

                                </span>
                            </td>
                            <td>
                                <span class="text-gray-700"><?php echo e($app->created_at->format('d M Y')); ?></span>
                            </td>
                            <td class="text-end pe-4">
                                <a href="<?php echo e(route('health_staff.personalDetail', $app->id)); ?>" class="btn btn-sm btn-light btn-active-primary">
            ...
            <div class="d-flex justify-content-between align-items-center mt-5">
                <div class="text-gray-600">
                    Showing <?php echo e($applications->firstItem() ?? 0); ?> to <?php echo e($applications->lastItem() ?? 0); ?> of <?php echo e($applications->total()); ?> entries
                </div>
                <div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\work\laragon\www\delegation\resources\views/health_staff/index.blade.php ENDPATH**/ ?>