        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                <h1 style="font-size: 1.75rem; font-weight: 700; margin: 0; color: white;">
                    <i class="ki-duotone ki-rocket fs-2x me-2" style="vertical-align: middle;">
                                ...
                                <div id="medical_needs_repeater">
                                    ...
                                    <div class="form-group mt-5">
                                        ...
                                        <button type="button" data-repeater-create=""
                                                class="btn btn-sm"
                                                style="background: linear-gradient(135deg, #28a745 0%, #218838 100%); color: white; padding: 0.75rem 1.5rem; font-weight: 600;">
                            ...
                            <div id="additional_requirements_repeater">
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <button type="button" data-repeater-create=""
                                            class="btn btn-sm"
                                            style="background: linear-gradient(135deg, #28a745 0%, #218838 100%); color: white; padding: 0.75rem 1.5rem; font-weight: 600;">
                                        <i class="ki-outline ki-plus fs-2"></i>Add Another Requirement
                                    </button>
                                    <!--end::Button-->
                                </div>
                                <!--end::Form group-->
